...
impl AddSpendingLimitAsAuthority {
  pub fn instruction(&self, args: AddSpendingLimitAsAuthorityInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddSpendingLimitAsAuthorityInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&AddSpendingLimitAsAuthorityInstructionData::new()).unwrap();
    ...
    pub fn program(&mut self, program: solana_pubkey::Pubkey) -> &mut Self {
      ...
      pub fn signers(&mut self, signers: Vec<Pubkey>) -> &mut Self {
        ...
        self
                ...
                #[inline(always)]
      pub fn destinations(&mut self, destinations: Vec<Pubkey>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = AddSpendingLimitAsAuthorityInstructionArgs {
                                                              seed: self.instruction.seed.clone().expect("seed is not set"),
                                                                  ...
                                                                  destinations: self.instruction.destinations.clone().expect("destinations is not set"),
