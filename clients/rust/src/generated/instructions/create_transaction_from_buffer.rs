...
#[inline(always)]
    ...
    pub fn transaction_buffer(&mut self, transaction_buffer: solana_pubkey::Pubkey) -> &mut Self {
            ...
            #[inline(always)]
    pub fn from_buffer_creator(&mut self, from_buffer_creator: solana_pubkey::Pubkey) -> &mut Self {
                        self.from_buffer_creator = Some(from_buffer_creator);
                    self
    }
                    #[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CreateTransactionFromBuffer {
                              settings: self.settings.expect("settings is not set"),
                                        ...
                                        from_buffer_creator: self.from_buffer_creator.expect("from_buffer_creator is not set"),
                      };
...
#[inline(always)]
    ...
    pub fn transaction_buffer(&mut self, transaction_buffer: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      #[inline(always)]
    pub fn from_buffer_creator(&mut self, from_buffer_creator: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          from_buffer_creator: self.instruction.from_buffer_creator.expect("from_buffer_creator is not set"),
                          __args: args,
            };
