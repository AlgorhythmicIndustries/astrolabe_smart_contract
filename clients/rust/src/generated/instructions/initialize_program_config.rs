...
impl InitializeProgramConfig {
  pub fn instruction(&self, args: InitializeProgramConfigInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: InitializeProgramConfigInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&InitializeProgramConfigInstructionData::new()).unwrap();
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = InitializeProgramConfig {
                              program_config: self.program_config.expect("program_config is not set"),
                                        initializer: self.initializer.unwrap_or(solana_pubkey::pubkey!("BrQAbGdWQ9YUHmWWgKFdFe4miTURH71jkYFPXfaosqDv")),
          ...
          let args = InitializeProgramConfigInstructionArgs {
                                                              authority: self.authority.clone().expect("authority is not set"),
                                                                  smart_account_creation_fee: self.smart_account_creation_fee.clone().expect("smart_account_creation_fee is not set"),
...
impl<'a, 'b> InitializeProgramConfigCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    ...
    pub fn program_config(&mut self, program_config: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The hard-coded account that is used to initialize the program config once.
#[inline(always)]
    pub fn initializer(&mut self, initializer: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = InitializeProgramConfigInstructionArgs {
                                                              authority: self.instruction.authority.clone().expect("authority is not set"),
                                                                  smart_account_creation_fee: self.instruction.smart_account_creation_fee.clone().expect("smart_account_creation_fee is not set"),
                                                                  treasury: self.instruction.treasury.clone().expect("treasury is not set"),
                                    };
        ...
        __program: self.instruction.__program,
          ...
          initializer: self.instruction.initializer.expect("initializer is not set"),
