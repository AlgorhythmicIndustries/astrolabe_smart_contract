...
impl ChangeThresholdAsAuthority {
  pub fn instruction(&self, args: ChangeThresholdAsAuthorityInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: ChangeThresholdAsAuthorityInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&ChangeThresholdAsAuthorityInstructionData::new()).unwrap();
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = ChangeThresholdAsAuthority {
          ...
          let args = ChangeThresholdAsAuthorityInstructionArgs {
                                                              new_threshold: self.new_threshold.clone().expect("new_threshold is not set"),
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = ChangeThresholdAsAuthorityInstructionArgs {
                                                              new_threshold: self.instruction.new_threshold.clone().expect("new_threshold is not set"),
