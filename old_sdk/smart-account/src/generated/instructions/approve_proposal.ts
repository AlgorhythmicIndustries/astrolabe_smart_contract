 ...
 * @category generated
 */
export const approve_proposalStruct = new beet.FixableBeetArgsStruct<
...
/**
 * Accounts required by the _ApproveProposalInstructionAccounts_ instruction
 *
 * @property [] settings
 * @property [] signer
 * @property [] proposal
...
export function createApproveProposalInstruction(
  ...
  const [data] = approve_proposalStruct.serialize({
