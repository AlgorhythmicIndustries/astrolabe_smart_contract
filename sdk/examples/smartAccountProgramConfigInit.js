        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    keypairFile = fs_1.default.readFileSync('/Users/algorhythmic/.config/solana/id.json');
                    keypairBytes = new Uint8Array(JSON.parse(keypairFile.toString()));
                    initializerKeypairFile = fs_1.default.readFileSync('../../test-program-config-initializer-keypair.json');
