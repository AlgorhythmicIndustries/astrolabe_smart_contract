import {
  ...
  async function main() {
    ...
    const rpc = createSolanaRpc('https://devnet.helius-rpc.com/?api-key=34ff2ba3-5858-43cc-a351-b2cf9b3420fb');
    const rpcSubscriptions = createSolanaRpcSubscriptions('wss://devnet.helius-rpc.com/?api-key=34ff2ba3-5858-43cc-a351-b2cf9b3420fb');
  
    // Get bytes from local keypair file.
    const keypairFile = fs.readFileSync('/Users/algorhythmic/.config/solana/deployer.json');
