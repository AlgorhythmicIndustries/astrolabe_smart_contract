...
export declare const USE_SPENDING_LIMIT_DISCRIMINATOR: Uint8Array;
...
export type ParsedUseSpendingLimitInstruction<TProgram extends string = typeof ASTROLABE_SMART_ACCOUNT_PROGRAM_ADDRESS, TAccountMetas extends readonly IAccountMeta[] = readonly IAccountMeta[]> = {
...
export declare function parseUseSpendingLimitInstruction<TProgram extends string, TAccountMetas extends readonly IAccountMeta[]>(instruction: IInstruction<TProgram> & IInstructionWithAccounts<TAccountMetas> & IInstructionWithData<Uint8Array>): ParsedUseSpendingLimitInstruction<TProgram, TAccountMetas>;
