...
export declare const CLOSE_BATCH_DISCRIMINATOR: Uint8Array;
...
export declare function getCloseBatchInstructionDataEncoder(): FixedSizeEncoder<CloseBatchInstructionDataArgs>;
export declare function getCloseBatchInstructionDataDecoder(): FixedSizeDecoder<CloseBatchInstructionData>;
export declare function getCloseBatchInstructionDataCodec(): FixedSizeCodec<CloseBatchInstructionDataArgs, CloseBatchInstructionData>;
...
export type ParsedCloseBatchInstruction<TProgram extends string = typeof ASTROLABE_SMART_ACCOUNT_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = {
...
export declare function parseCloseBatchInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas> & InstructionWithData<ReadonlyUint8Array>): ParsedCloseBatchInstruction<TProgram, TAccountMetas>;
