...
export declare const CLOSE_SETTINGS_TRANSACTION_DISCRIMINATOR: Uint8Array;
...
export declare function getCloseSettingsTransactionInstructionDataEncoder(): FixedSizeEncoder<CloseSettingsTransactionInstructionDataArgs>;
export declare function getCloseSettingsTransactionInstructionDataDecoder(): FixedSizeDecoder<CloseSettingsTransactionInstructionData>;
export declare function getCloseSettingsTransactionInstructionDataCodec(): FixedSizeCodec<CloseSettingsTransactionInstructionDataArgs, CloseSettingsTransactionInstructionData>;
...
export type ParsedCloseSettingsTransactionInstruction<TProgram extends string = typeof ASTROLABE_SMART_ACCOUNT_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = {
