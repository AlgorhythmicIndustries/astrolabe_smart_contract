 ...
 * @category generated
 */
export const close_batch_transactionStruct = new beet.BeetArgsStruct<{
...
/**
 * Accounts required by the _CloseBatchTransactionInstructionAccounts_ instruction
 *
 * @property [] settings
 * @property [] proposal
 * @property [] batch
...
export function createCloseBatchTransactionInstruction(
  ...
  const [data] = close_batch_transactionStruct.serialize({
