 ...
 * @category generated
 */
export const change_threshold_as_authorityStruct =
...
/**
 * Accounts required by the _ChangeThresholdAsAuthorityInstructionAccounts_ instruction
 *
 * @property [] settings
...
export function createChangeThresholdAsAuthorityInstruction(
  ...
  const [data] = change_threshold_as_authorityStruct.serialize({
