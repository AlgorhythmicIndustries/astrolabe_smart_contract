 ...
 * @category generated
 */
export const close_settings_transactionStruct = new beet.BeetArgsStruct<{
...
/**
 * Accounts required by the _CloseSettingsTransactionInstructionAccounts_ instruction
 *
 * @property [] settings
 * @property [] proposal
