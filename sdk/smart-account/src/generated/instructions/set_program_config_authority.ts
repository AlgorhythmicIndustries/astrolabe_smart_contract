 ...
 * @category generated
 */
export const set_program_config_authorityStruct = new beet.BeetArgsStruct<
...
/**
 * Accounts required by the _SetProgramConfigAuthorityInstructionAccounts_ instruction
 *
...
export function createSetProgramConfigAuthorityInstruction(
  ...
  const [data] = set_program_config_authorityStruct.serialize({
