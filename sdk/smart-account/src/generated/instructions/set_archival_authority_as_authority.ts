 ...
 * @category generated
 */
export const set_archival_authority_as_authorityStruct =
...
/**
 * Accounts required by the _SetArchivalAuthorityAsAuthorityInstructionAccounts_ instruction
 *
 * @property [] settings
...
export function createSetArchivalAuthorityAsAuthorityInstruction(
  ...
  const [data] = set_archival_authority_as_authorityStruct.serialize({
