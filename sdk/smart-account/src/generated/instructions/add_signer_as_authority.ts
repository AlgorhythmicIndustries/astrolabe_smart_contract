 ...
 * @category generated
 */
export const add_signer_as_authorityStruct = new beet.FixableBeetArgsStruct<
...
/**
 * Accounts required by the _AddSignerAsAuthorityInstructionAccounts_ instruction
 *
 * @property [] settings
...
export function createAddSignerAsAuthorityInstruction(
  ...
  const [data] = add_signer_as_authorityStruct.serialize({
