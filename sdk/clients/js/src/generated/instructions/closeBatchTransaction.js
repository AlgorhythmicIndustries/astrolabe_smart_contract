...
function getCloseBatchTransactionInstructionDataEncoder() {
    return (0, kit_1.transformEncoder)((0, kit_1.getStructEncoder)([['discriminator', (0, kit_1.fixEncoderSize)((0, kit_1.getBytesEncoder)(), 8)]]), function (value) { return (__assign(__assign({}, value), { discriminator: exports.CLOSE_BATCH_TRANSACTION_DISCRIMINATOR })); });
}
