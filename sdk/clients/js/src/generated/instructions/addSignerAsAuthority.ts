...
export function getAddSignerAsAuthorityInstructionDataCodec(): Codec<
  AddSignerAsAuthorityInstructionDataArgs,
  AddSignerAsAuthorityInstructionData
> {
  return combineCodec(
...
export function parseAddSignerAsAuthorityInstruction<
