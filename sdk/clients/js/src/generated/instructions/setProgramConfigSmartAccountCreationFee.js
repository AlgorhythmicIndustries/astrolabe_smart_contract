...
function getSetProgramConfigSmartAccountCreationFeeInstructionDataEncoder() {
    ...
    ]), function (value) { return (__assign(__assign({}, value), { discriminator: exports.SET_PROGRAM_CONFIG_SMART_ACCOUNT_CREATION_FEE_DISCRIMINATOR })); });
}
...
function getSetProgramConfigSmartAccountCreationFeeInstructionAsync(input, config) {
