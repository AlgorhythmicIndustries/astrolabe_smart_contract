...
function getCreateBatchInstructionDataEncoder() {
    ...
    ]), function (value) { return (__assign(__assign({}, value), { discriminator: exports.CREATE_BATCH_DISCRIMINATOR })); });
}
...
function getCreateBatchInstruction(input, config) {
    ...
    var originalAccounts = {
        ...
        batch: { value: (_c = input.batch) !== null && _c !== void 0 ? _c : null, isWritable: true },
