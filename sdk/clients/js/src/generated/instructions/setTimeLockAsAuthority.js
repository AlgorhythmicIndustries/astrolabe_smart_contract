...
exports.SET_TIME_LOCK_AS_AUTHORITY_DISCRIMINATOR = new Uint8Array([
...
function getSetTimeLockAsAuthorityInstructionDataEncoder() {
    ...
    ]), function (value) { return (__assign(__assign({}, value), { discriminator: exports.SET_TIME_LOCK_AS_AUTHORITY_DISCRIMINATOR })); });
}
...
function getSetTimeLockAsAuthorityInstruction(input, config) {
    ...
    return Object.freeze({
        ...
        data: getSetTimeLockAsAuthorityInstructionDataEncoder().encode(args),
