...
function getExecuteTransactionSyncInstructionDataEncoder() {
    ...
    ]), function (value) { return (__assign(__assign({}, value), { discriminator: exports.EXECUTE_TRANSACTION_SYNC_DISCRIMINATOR })); });
}
...
function getExecuteTransactionSyncInstruction(input, config) {
    ...
    var originalAccounts = {
        ...
        program: { value: (_c = input.program) !== null && _c !== void 0 ? _c : null, isWritable: false },
    };
