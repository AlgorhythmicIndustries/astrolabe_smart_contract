...
function getSetProgramConfigAuthorityInstructionDataEncoder() {
    ...
    ]), function (value) { return (__assign(__assign({}, value), { discriminator: exports.SET_PROGRAM_CONFIG_AUTHORITY_DISCRIMINATOR })); });
}
...
function getSetProgramConfigAuthorityInstructionAsync(input, config) {
