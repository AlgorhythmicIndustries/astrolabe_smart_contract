...
exports.CREATE_TRANSACTION_FROM_BUFFER_DISCRIMINATOR = new Uint8Array([
...
function getCreateTransactionFromBufferInstructionDataEncoder() {
    ...
    ]), function (value) { return (__assign(__assign({}, value), { discriminator: exports.CREATE_TRANSACTION_FROM_BUFFER_DISCRIMINATOR })); });
}
...
function getCreateTransactionFromBufferInstruction(input, config) {
    ...
    var originalAccounts = {
        ...
        transactionBuffer: {
            value: (_g = input.transactionBuffer) !== null && _g !== void 0 ? _g : null,
            isWritable: true,
        },
        bufferCreator: { value: (_h = input.bufferCreator) !== null && _h !== void 0 ? _h : null, isWritable: true },
    };
