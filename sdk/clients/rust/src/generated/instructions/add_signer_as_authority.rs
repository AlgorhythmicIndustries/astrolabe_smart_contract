...
impl AddSignerAsAuthority {
  pub fn instruction(&self, args: AddSignerAsAuthorityInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: AddSignerAsAuthorityInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
pub struct AddSignerAsAuthorityBuilder {
            settings: Option<solana_pubkey::Pubkey>,
                ...
                program: Option<solana_pubkey::Pubkey>,
                        new_signer: Option<SmartAccountSigner>,
                memo: Option<String>,
        __remaining_accounts: Vec<solana_instruction::AccountMeta>,
}

impl AddSignerAsAuthorityBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
    pub fn program(&mut self, program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn new_signer(&mut self, new_signer: SmartAccountSigner) -> &mut Self {
        self.new_signer = Some(new_signer);
        self
      }
                /// `[optional argument]`
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = AddSignerAsAuthority {
          ...
          let args = AddSignerAsAuthorityInstructionArgs {
                                                              new_signer: self.new_signer.clone().expect("new_signer is not set"),
  ...
  /// `add_signer_as_authority` CPI accounts.
  pub struct AddSignerAsAuthorityCpiAccounts<'a, 'b> {
...
/// `add_signer_as_authority` CPI instruction.
pub struct AddSignerAsAuthorityCpi<'a, 'b> {
...
/// This is usually the same as `settings_authority`, but can be a different account if needed.
    ...
    pub __args: AddSignerAsAuthorityInstructionArgs,
  }

impl<'a, 'b> AddSignerAsAuthorityCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: AddSignerAsAuthorityCpiAccounts<'a, 'b>,
...
/// Instruction builder for `AddSignerAsAuthority` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` settings
          ...
          ///   4. `[]` program
#[derive(Clone, Debug)]
pub struct AddSignerAsAuthorityCpiBuilder<'a, 'b> {
  instruction: Box<AddSignerAsAuthorityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> AddSignerAsAuthorityCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(AddSignerAsAuthorityCpiBuilderInstruction {
      __program: program,
              settings: None,
...
#[inline(always)]
    ...
    pub fn program(&mut self, program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn new_signer(&mut self, new_signer: SmartAccountSigner) -> &mut Self {
        self.instruction.new_signer = Some(new_signer);
        self
      }
                /// `[optional argument]`
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = AddSignerAsAuthorityInstructionArgs {
                                                              new_signer: self.instruction.new_signer.clone().expect("new_signer is not set"),
                                                                  memo: self.instruction.memo.clone(),
                                    };
        let instruction = AddSignerAsAuthorityCpi {
...
#[derive(Clone, Debug)]
struct AddSignerAsAuthorityCpiBuilderInstruction<'a, 'b> {
