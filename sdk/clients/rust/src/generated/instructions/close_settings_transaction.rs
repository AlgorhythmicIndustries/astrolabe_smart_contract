...
pub struct CloseSettingsTransaction {
          ...
          pub transaction_rent_collector: solana_pubkey::Pubkey,
...
impl CloseSettingsTransaction {
  ...
  pub fn instruction_with_remaining_accounts(&self, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let data = borsh::to_vec(&CloseSettingsTransactionInstructionData::new()).unwrap();
...
pub struct CloseSettingsTransactionBuilder {
            settings: Option<solana_pubkey::Pubkey>,
                ...
                transaction_rent_collector: Option<solana_pubkey::Pubkey>,
...
#[inline(always)]
    pub fn proposal_rent_collector(&mut self, proposal_rent_collector: solana_pubkey::Pubkey) -> &mut Self {
            ...
            /// The rent collector.
#[inline(always)]
    pub fn transaction_rent_collector(&mut self, transaction_rent_collector: solana_pubkey::Pubkey) -> &mut Self {
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = CloseSettingsTransaction {
                              settings: self.settings.expect("settings is not set"),
                                        ...
                                        transaction_rent_collector: self.transaction_rent_collector.expect("transaction_rent_collector is not set"),
...
#[inline(always)]
    pub fn proposal_rent_collector(&mut self, proposal_rent_collector: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
      ...
      /// The rent collector.
#[inline(always)]
    pub fn transaction_rent_collector(&mut self, transaction_rent_collector: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        __program: self.instruction.__program,
          ...
          transaction_rent_collector: self.instruction.transaction_rent_collector.expect("transaction_rent_collector is not set"),
