...
///   6. `[optional]` program (default to `7DhtuVpz4WuAN1dfJH2pK7ACKq3f1VUaqcvrzuNwc2rS`)
...
impl CreateSmartAccountBuilder {
    ...
    #[inline(always)]
    pub fn restricted_signers(
        &mut self,
        restricted_signers: Vec<RestrictedSmartAccountSigner>,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = CreateSmartAccountInstructionArgs {
            ...
            restricted_signers: self
                .restricted_signers
                .clone()
                .expect("restricted_signers is not set"),
