...
impl SetNewSettingsAuthorityAsAuthority {
  pub fn instruction(&self, args: SetNewSettingsAuthorityAsAuthorityInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: SetNewSettingsAuthorityAsAuthorityInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
    ...
    let mut data = borsh::to_vec(&SetNewSettingsAuthorityAsAuthorityInstructionData::new()).unwrap();
...
impl SetNewSettingsAuthorityAsAuthorityBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
    pub fn program(&mut self, program: solana_pubkey::Pubkey) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn new_settings_authority(&mut self, new_settings_authority: Pubkey) -> &mut Self {
        self.new_settings_authority = Some(new_settings_authority);
        self
      }
                /// `[optional argument]`
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_instruction::Instruction {
    let accounts = SetNewSettingsAuthorityAsAuthority {
          ...
          let args = SetNewSettingsAuthorityAsAuthorityInstructionArgs {
                                                              new_settings_authority: self.new_settings_authority.clone().expect("new_settings_authority is not set"),
  ...
  /// `set_new_settings_authority_as_authority` CPI accounts.
  pub struct SetNewSettingsAuthorityAsAuthorityCpiAccounts<'a, 'b> {
...
/// `set_new_settings_authority_as_authority` CPI instruction.
pub struct SetNewSettingsAuthorityAsAuthorityCpi<'a, 'b> {
...
/// This is usually the same as `settings_authority`, but can be a different account if needed.
    ...
    pub __args: SetNewSettingsAuthorityAsAuthorityInstructionArgs,
  }

impl<'a, 'b> SetNewSettingsAuthorityAsAuthorityCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: SetNewSettingsAuthorityAsAuthorityCpiAccounts<'a, 'b>,
...
/// Instruction builder for `SetNewSettingsAuthorityAsAuthority` via CPI.
///
/// ### Accounts:
///
                ///   0. `[writable]` settings
          ...
          ///   4. `[]` program
#[derive(Clone, Debug)]
pub struct SetNewSettingsAuthorityAsAuthorityCpiBuilder<'a, 'b> {
  instruction: Box<SetNewSettingsAuthorityAsAuthorityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> SetNewSettingsAuthorityAsAuthorityCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(SetNewSettingsAuthorityAsAuthorityCpiBuilderInstruction {
      __program: program,
              settings: None,
...
#[inline(always)]
    ...
    pub fn program(&mut self, program: &'b solana_account_info::AccountInfo<'a>) -> &mut Self {
                    ...
                    #[inline(always)]
      pub fn new_settings_authority(&mut self, new_settings_authority: Pubkey) -> &mut Self {
        self.instruction.new_settings_authority = Some(new_settings_authority);
        self
      }
                /// `[optional argument]`
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
          let args = SetNewSettingsAuthorityAsAuthorityInstructionArgs {
                                                              new_settings_authority: self.instruction.new_settings_authority.clone().expect("new_settings_authority is not set"),
                                                                  memo: self.instruction.memo.clone(),
                                    };
        let instruction = SetNewSettingsAuthorityAsAuthorityCpi {
...
#[derive(Clone, Debug)]
struct SetNewSettingsAuthorityAsAuthorityCpiBuilderInstruction<'a, 'b> {
