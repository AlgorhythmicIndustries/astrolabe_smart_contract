...
impl RejectProposal {
  pub fn instruction(&self, args: RejectProposalInstructionArgs) -> solana_instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::arithmetic_side_effects)]
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: RejectProposalInstructionArgs, remaining_accounts: &[solana_instruction::AccountMeta]) -> solana_instruction::Instruction {
...
impl RejectProposalInstructionData {
  pub fn new() -> Self {
    Self {
...
pub struct RejectProposalBuilder {
...
#[inline(always)]
  ...
  /// `reject_proposal` CPI accounts.
  pub struct RejectProposalCpiAccounts<'a, 'b> {
...
/// `reject_proposal` CPI instruction.
pub struct RejectProposalCpi<'a, 'b> {
  ...
  pub __program: &'b solana_account_info::AccountInfo<'a>,
    ...
    pub __args: RejectProposalInstructionArgs,
  }

impl<'a, 'b> RejectProposalCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_account_info::AccountInfo<'a>,
          accounts: RejectProposalCpiAccounts<'a, 'b>,
...
/// Instruction builder for `RejectProposal` via CPI.
///
/// ### Accounts:
///
          ///   0. `[]` settings
...
#[derive(Clone, Debug)]
pub struct RejectProposalCpiBuilder<'a, 'b> {
  instruction: Box<RejectProposalCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> RejectProposalCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(RejectProposalCpiBuilderInstruction {
      __program: program,
              settings: None,
              signer: None,
              proposal: None,
...
#[inline(always)]
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_entrypoint::ProgramResult {
        ...
        let instruction = RejectProposalCpi {
...
#[derive(Clone, Debug)]
struct RejectProposalCpiBuilderInstruction<'a, 'b> {
