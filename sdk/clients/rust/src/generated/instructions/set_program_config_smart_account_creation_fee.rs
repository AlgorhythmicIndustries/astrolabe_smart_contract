...
impl SetProgramConfigSmartAccountCreationFeeBuilder {
    ...
    #[inline(always)]
    pub fn new_smart_account_creation_fee(
        &mut self,
        new_smart_account_creation_fee: u64,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = SetProgramConfigSmartAccountCreationFeeInstructionArgs {
            new_smart_account_creation_fee: self
                .new_smart_account_creation_fee
                .clone()
                .expect("new_smart_account_creation_fee is not set"),
        };
...
impl<'a, 'b> SetProgramConfigSmartAccountCreationFeeCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(
            SetProgramConfigSmartAccountCreationFeeCpiBuilderInstruction {
                __program: program,
                program_config: None,
                authority: None,
